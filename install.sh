...
echo '/usr/bin/python /opt/retropie/configs/all/DynamicBezel/DynamicBezel.py /dev/input/js0 &' >> /opt/retropie/configs/all/runcommand-onstart.sh
echo '/usr/bin/python /opt/retropie/configs/all/DynamicBezel/DynamicBezel.py /dev/input/js1 &' >> /opt/retropie/configs/all/runcommand-onstart.sh
