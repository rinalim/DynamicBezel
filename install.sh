sudo apt install python3-pyudev python3-bitstring -y
...
echo 'sudo /usr/bin/python3 /opt/retropie/configs/all/DynamicBezel/DynamicBezel.py /dev/input/js0 > /dev/null 2>&1 &' >> /opt/retropie/configs/all/runcommand-onstart.sh
